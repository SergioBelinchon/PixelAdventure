...
with HasGameRef<PixelAdventure>, CollisionCallbacks
{
  ...
  bool player1InRange()
  {
    double playerOffset = (player1.scale.x > 0) ? 0 : -player1.width;

    return player1.x + playerOffset >= rangeNeg &&
    player1.x + playerOffset <= rangePos &&
  ...
  bool player2InRange()
  {
    ...
    return player2.x + playerOffset >= rangeNeg &&
        player2.x + playerOffset <= rangePos &&
